<head>
	<title>Puskita - Pengembalian</title>
	<meta charset="UTF-8">
	<meta charset="utf-8">
...
<body style="background-color:#d8d8d8">
	...
	<div class="container-fluid" style="width:600px; padding-top:40px; padding-bottom:60px; background-color:white">
		<center>
			...
			<form class="form-borrowing" action="<?php echo base_url('transaction/returnBook');?>" method="post">
				<table>
					<tr>
			...
			<form class="form-borrowing-description" action="<?php echo base_url('transaction/addReturn/'.$id_anggota.'/'.$isbn);?>" method="post">
